...
@Component({
  selector: 'app-historypageadmin',
  templateUrl: './historypageadmin.component.html',
  styleUrls: ['./historypageadmin.component.css']
})
export class HistorypageadminComponent {
  orders: AdminOrder[] = [];
  pageSize = 10;
  pageIndex = 0;
